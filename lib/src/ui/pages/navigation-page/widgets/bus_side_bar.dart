...
//                 children: [
//                   Row(children: [
//                     Icon(Icons.directions_bus, color: Colors.white, size: height*0.025),
//                     const SizedBox(
//                       width: 10,
//                     ),
...
//                   Row(
//                     children: [
//                       Icon(Icons.arrow_forward_ios, color: Colors.white, size: height*0.025),
//                       const SizedBox(
//                         width: 10,
//                       ),
...
//                   Row(
//                     children: [
//                       Icon(Icons.groups, color: Colors.white, size: height*0.025),
//                       const SizedBox(
//                         width: 10,
//                       ),
