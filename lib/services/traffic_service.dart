...
class TrafficService{
  ...
  final _apiKey = 'pk.eyJ1IjoiZWxpYXNkaWF6MTAwNSIsImEiOiJja3d4eDQ3OTcwaHk3Mm51cjNmcWRvZjA2In0.AAF794oxyxFR_-wAvVwMfQ';

  Future<SearchResponse> getQueryResults( String search, LatLng proximity) async {

    final url = '${ this._baseUrl }/mapbox.places/$search.json';
    try {
